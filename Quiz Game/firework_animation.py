...
bang = pygame.mixer.Sound("C:/Users/Hercules/python/Pratica/Quiz Game/bang_05.ogg")
bang1 = pygame.mixer.Sound("C:/Users/Hercules/python/Pratica/Quiz Game/bang_06.ogg")
bang2= pygame.mixer.Sound("C:/Users/Hercules/python/Pratica/Quiz Game/bang_07.ogg")
cannon = pygame.mixer.Sound("C:/Users/Hercules/python/Pratica/Quiz Game/cannon_03.ogg")
fw = pygame.mixer.Sound("C:/Users/Hercules/python/Pratica/Quiz Game/fw_03.ogg")
...
class Projectile:
    ...
    def move(self):
        self.x += self.x_vel
        self.y += self.y_vel
        self.alpha = max(0,self.alpha - self.ALPHA_DECREMENTE)
...
def main():
    ...
    launchers = [
        ...
        Launcher( 300, HEIGHT - Launcher.HEIGHT, 2000),
        Launcher( 500 , HEIGHT - Launcher.HEIGHT, 4000),
